...
/* The one-board eval fixture is not a vehicle CAN-contract image.  Keep the
 * task buildable and bounded to its sole monitor instead of iterating the
 * five-segment production phase schedule. */
#define CAN_TELEMETRY_PHASE_COUNT 1u
#else
