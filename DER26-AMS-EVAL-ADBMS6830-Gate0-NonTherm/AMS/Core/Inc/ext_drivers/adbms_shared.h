...
/* Full configuration keeps REFON asserted; the eval monitor-only profile may
 * remain at its reset default. In both cases the first checked wake, this
 * pre-conversion interval, and the checked wake inside ADCV together exceed
 * the 4.4 ms worst-case reference wake time. The documented redundant
