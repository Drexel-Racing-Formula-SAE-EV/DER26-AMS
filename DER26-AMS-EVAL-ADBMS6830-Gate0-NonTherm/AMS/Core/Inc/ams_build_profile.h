...
/* This branch is intentionally ready-to-flash for the isolated
 * EVAL-ADBMS6830BMSW bring-up.  Every ordinary/HIL/vehicle regression target
 * explicitly overrides this to 0 so the eval topology cannot leak into a
 * different image by accident. */
...
/* The physical eval-board image is a strict subset of the bench profile. */
#if AMS_EVAL_ADBMS6830_BMSW
#if AMS_BUILD_PROFILE != AMS_PROFILE_BENCH
#error "EVAL-ADBMS6830BMSW requires AMS_PROFILE_BENCH"
#endif
#if !AMS_HW_BRINGUP
#error "EVAL-ADBMS6830BMSW requires AMS_HW_BRINGUP=1"
#endif
#if AMS_HIL_REPLACE_ADBMS || AMS_ENABLE_HIL_CAN
#error "Physical EVAL-ADBMS6830BMSW testing cannot use CAN-fed ADBMS HIL"
#endif
#if !AMS_ENABLE_SERVICE_CLI
#error "EVAL-ADBMS6830BMSW requires the controlled service CLI"
#endif

/* One EVAL-ADBMS6830BMSW contains one ADBMS6830B and sixteen cell inputs.
 * It is connected to the AMS ADBMS6822 through String B for this fixture. */
#define AMS_ADBMS_MONITOR_COUNT              1
#define AMS_ADBMS_CELL_COUNT                16
#define AMS_ADBMS_PHYSICAL_CHAIN_COUNT       1
...
/* The APM is not present in the one-board fixture. */
#ifndef AMS_ENABLE_APM_2950
#define AMS_ENABLE_APM_2950 0
#endif
#if AMS_ENABLE_APM_2950
#error "ADBMS2950/APM must remain disabled in the 6830 eval-board profile"
#endif
