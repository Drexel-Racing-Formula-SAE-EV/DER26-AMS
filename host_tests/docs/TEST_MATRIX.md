...
| `test_fan_current_and_null_guards` | Verifies fan/current driver edge cases and defensive null handling. |
...
| `test_fault_matrix_extra` | Verifies hard/soft fault aggregation and BMS_OK safety behavior. |
