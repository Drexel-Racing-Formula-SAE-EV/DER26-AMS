...
static void write_output_header(FILE *output)
{
    fprintf(output,
        ...
        "prod_thermal_utilization,ref_thermal_utilization,state_abs_error,"
        "prod_utilization,ref_utilization,prod_remaining_utilization,"
        "ref_remaining_utilization,prod_equivalent_25c_current_a,"
        "ref_equivalent_25c_current_a,prod_typical_melt_time_s,"
        "ref_typical_melt_time_s,prod_usable_melt_time_s,"
        "ref_usable_melt_time_s,prod_exhausted,ref_exhausted,"
                             ...
                             const fuse_ref_result_t *rout)
{
    ...
    fprintf(output,
        ...
        "%.9g,%.12Lg,%.12Lg,%.9g,%.12Lg,%.9g,%.12Lg,"
        "%.9g,%.12Lg,%.9g,%.12Lg,%.9g,%.12Lg,%u,%u,"
        ...
        (double)pout->equivalent_25c_current_a,
        rout->equivalent_25c_current_a,
        (double)pout->typical_melt_time_s,
        rout->typical_melt_time_s,
        (double)pout->usable_melt_time_s,
        rout->usable_melt_time_s,
                              ...
                              const fuse_replay_summary_t *summary)
{
    ...
    fprintf(file,
        ...
        (double)AMS_FUSE_EAC14_80_RATED_CURRENT_A,
        summary->samples,
