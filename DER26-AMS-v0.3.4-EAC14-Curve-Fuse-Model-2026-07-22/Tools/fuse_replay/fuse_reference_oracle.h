/*
 * Independent high-precision reference for the DER26 EAC14-80 curve model.
 *
 * This module deliberately does not include or call production AMS headers or
 * functions.  It contains its own digitized curve, interpolation, thermal
 * state integration, and horizon-cap solver.
 */
...
/* Independent numerical integrator for dx/dt = -x/tau + source_rate. */
