...
const char *ams_fault_log_event_str(uint16_t event)
{
    ...
    case AMS_FAULT_LOG_ADBMS_FAULT_CHANGE: return "ADBMS_FAULT_CHANGE";
    case AMS_FAULT_LOG_ADBMS_STATE_TRANSITION: return "ADBMS_STATE_TRANSITION";
    case AMS_FAULT_LOG_ADBMS_DEVICE_RESET: return "ADBMS_DEVICE_RESET";
    case AMS_FAULT_LOG_ADBMS_FAULT_INJECTION: return "ADBMS_FAULT_INJECTION";
