...
static void refresh_can_snapshot(ams_power_state_t *state)
{
    ...
    can->discharge_binding_1s = (uint8_t)result->discharge_binding[1];
    can->charge_binding_1s = (uint8_t)result->charge_binding[1];
    can->discharge_limiting_segment_1s =
        result->discharge_limiting_segment[1];
    can->charge_limiting_segment_1s =
        result->charge_limiting_segment[1];
