...
result.production_charge_cap_A=[double(D.prod_charge_cap_0p1s_a), ...
    double(D.prod_charge_cap_1s_a),double(D.prod_charge_cap_10s_a), ...
    double(D.prod_charge_cap_30s_a)];
result.reference_charge_cap_A=[double(D.ref_charge_cap_0p1s_a), ...
    double(D.ref_charge_cap_1s_a),double(D.ref_charge_cap_10s_a), ...
    double(D.ref_charge_cap_30s_a)];
