...
charge_cap_nonconservative=max(0,replay.production_charge_cap_A- ...
    replay.reference_charge_cap_A);
report=struct();
...
report.max_charge_cap_nonconservative_A=max( ...
    charge_cap_nonconservative,[],'all');
...
report.pass=report.strict_replay_pass && ...
    ...
    report.max_charge_cap_nonconservative_A<= ...
        acceptance.cap_nonconservative_tolerance_A;
